...
// ------------------------------
// ROTAS TEMPORÁRIAS — USE UMA VEZ SÓ, DEPOIS APAGUE!
// ------------------------------
...
res.send('✅ TODAS AS TABELAS CRIADAS COM SUCESSO!
Criar usuário admin');
} catch (e) {
...
await bd.execute(
INSERT INTO processos_originais (id_processo_unificado,numero,data,tipificacao,descricao) VALUES (?,?,?,?,?),[idPessoa, num, dt || null, tip, desc]
);
}
}
if (dados.id) {
...
// ===============================================================================================
// ✅ INICIA O SERVIDOR — ÚNICA DECLARAÇÃO DA VARIÁVEL "PORTA"
// ===============================================================================================
